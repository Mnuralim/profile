    ...
    <div>
      <nav className="navbar navbar-expand-lg bg-body-primary bg-primary sticky-top">
        <div className="container-fluid">
          <Link to={"/"} className="navbar-brand text-white active" href="#">
            HMPS ILKOM
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link to={"/"} className="nav-link transform" aria-current="page" href="index.html">
                  Home
                </Link>
              </li>
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link to={"/profile"} className="dropdown-item" href="profil.html" title="profil">
                      visi, Misi dan Sejarah
                    </Link>
                  </li>

                  <li>
                    <Link to={"/profile"} className="dropdown-item" href="profil.html">
                      Struktur Organisasi
                    </Link>
                  </li>
                </ul>
